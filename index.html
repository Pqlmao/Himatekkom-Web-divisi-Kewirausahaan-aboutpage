...
<html lang="en">
  <head>
    ...
    <link
      href="https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;700&family=Roboto:wght@400;500&display=swap"
      rel="stylesheet"
    />
    ...
    <div class="footer">
      ...
      <div class="footer-section">
        <div class="footer-info">
          ...
          <div class="footer-item">Product</div>
          <div class="footer-item">Blog</div>
        </div>
        <div class="footer-info">
          <div class="footer-title">Company</div>
          <div class="footer-item">Community</div>
          <div class="footer-item">Career</div>
          <div class="footer-item">Our story</div>
        </div>
        <div class="footer-info">
          <div class="footer-title">Contact</div>
          <div class="footer-item">Getting Started</div>
          <div class="footer-item">Pricing</div>
          <div class="footer-item">Resources</div>
        </div>
      </div>
      <div class="copyright">2024 all Right Reserved Term of use</div>
    </div>
  </body>
</html>
